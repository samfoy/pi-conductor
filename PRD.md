...
- 2026-05-28 — **v0.12 steering — locked decisions Q1/Q2/Q6/Q9 + oracle fixes #1–#3 + Risk 2** (8 slice commits `3f73d9d..<v0.12-close>`; design `docs/v0.12-steering-design.md`; plan `docs/v0.12-steering-plan.md`).
